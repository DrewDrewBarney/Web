...
<html>
    ...
    <?php
    makeBanner("Training Load & Performance​​", ['home'=>'index.php'])->echo();
    ?>
    ...
    <body>
        ...
        <article>
            <h3>Training Load and Performance</h3>
            ...
            <p>
                ...
                We have to be wary of model curves with good yet insignificant correlations to experimental data.
            </p>
