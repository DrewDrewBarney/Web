...
<html>
    ...
    <?php makeHead('The Physiology of Training')->echo(); ?>
    ...
    <body>
        ...
        $div->addChildren([
            ...
            makeMenu(MENU_BASIS, 'physiology.php'),
            makePageTitle('The Physiology of Zone Based Training')
        ]);
        ...
        <article>
            ...
            <figure style="width:25%;float: right; margin: 10px 0px 20px 50px; ">
                <img src ="../Images/Zatopek.png" style="width:100%;border-radius: 30px;">
                <figcaption>
                    Emile Zatopek, Courtesy of Ghetty Images
            </figure>

            <p>
                Phased Zonal training (PZT) of which Interval Training is but one example uses the idea of carrying out an activity in different zones of intensity during different phases of a workout.  
            ...
            <p>                 
                <a class="buttonRight" href="https://www.youtube.com/watch?v=VkDYXUI1x08">80 20 Running</a>

                (I strongly recommend reading a copy of "80 20" Running by Matt Fitzgerald which provides both an interesting historic background and the scientific basis of this type of training)
            </p>            
            ...
            <p>
                Some schemes are in my opinion of more value than others.  They are discussed below.
            </p>

            <h2>Subjective Exercise Intensity "Measures"</h2>

            <h3>RPE Scales   </h3>


            <p>           
                Historically the earliest exercise intensity  zones were based on scales of "Rate" of Perceived Exertion (RPE).  
            ...
            <table class="tableStyle3">
                ...
                <tr>
                    ...
                    <th>Description of Exertion</th>
                </tr>

                <tr style="background-color: lightblue">
                    <td>6</td>
                    <td>No exertion; sitting and resting</td>
                </tr>
                <tr style="background-color: lightblue">
                    <td>7</td>
            ...
            <p>            
                I have found the development of objective physiological measures far more useful for my day to day training.​​
            </p>           

            <p>
                This involves measuring some value that is correlated to exercise intensity.  
            ...
            <h2>Objective Intensity Measures</h2>   

            <h3>Heart Rate Zones</h3>

            <p>            
                Heart rate is probably the second oldest objective measure of effort coming after pace.  
            ...
            <h4>Maximum Heart Rate based zones. 


            </h4>

            <p>            
                <a class="buttonRight" href="https://www.polar.com/fr/smart-coaching/what-are-heart-rate-zones?gclid=Cj0KCQjwvaeJBhCvARIsABgTDM6pCOGrvgAitBt4_iDoQa4aas6HMbAMluJnuhBA_A2tGN3WupnHggQaAoVIEALw_wcB">Polar HR Scheme</a>

                This is the simplest of schemes and produces zones as percentages of maximum heart rate.  
            ...
            <img src="../Images/Polar.png" class="centerImage33" >

            <h4>Heart Rate Reserve based zones. 


            </h4>

            <p>           
                <a class="buttonRight" href="https://www.running-addict.fr/conseil-running/formule-de-karvonen-calcul-zone-cardiaque/">
                    Karvonen
                </a>
                A better scheme is one that takes into account your resting heart rate in addition to your maximum heart rate and works out zones from percentages of the difference (heart rate reserve) between these two values.  
            ...
            <p>            
                So if we use Karvonen zones we need to know two things, resting heart rate and maximum heart rate.
            ...
            <p>
                I have seen athletes confound maximum heart rate with the maximum heart rate achieved during routine training.  
                They are different!  
            ...
            <p>            
                Formula methods provide an approximation to your maximum heart rate.  
                Some are better than others.  
                None are perfect. 
                The most commonly used (and worst) predicts your maximum heart rate to be:
            </p>

            <?php mountFormulaOnCard(makeEquation(['220 - age (in years)']))->echo(); ?>

            <p>I believe it is so popular because it is easy to remember and the calculation only requires a simple subtraction.  
                I would not however recommend using this.
                A better approximation is that developed by Tanaka.  It uses:
            </p>

            <?php mountFormulaOnCard(makeEquation(['209 - 0.7 x age (in years)']))->echo(); ?>

            <p>
                Even better approximations have been developed which also take in to account gender.
                These approximations are great for predicting the average maximum heart rate for a particular age <span style="font-weight: bold;font-style: italic;">in groups of people</span>, 
                but not so good at predicting maximum heart in a <span style="font-weight: bold;font-style: italic;">particular individual</span>.  
            ...
            <img class = "centerImage66" src = "../Images/AgePredictedMaxHR.png" alt ="pic">
            <div class="centredBoldText">Source: Age-predicted maximal heart rate in healthy subjects: The HUNT Fitness Study</div>

            <p>            
                If you are to use maximum heart rate as your datum on which to base your zone values then unfortunately you really need to measure it. 
            ...
            <p>            
                So are you stuck with having to actually measure your maximum HR with a field test?  
            ...
            <p>            
                The lactate threshold is a supremely important physiological event for endurance athletes.  
                ...
                The other problem is that glycolysis is highly inefficient and produces only a fraction (about <sup>1</sup>/<sub>15</sub>) of the energy produced from the metabolism of glucose with oxygen)
                It is wasteful of your precious glycogen reserves (you don't want to walk the last few miles of your marathon!)
            </p>
            <h4>VO<sub>2</sub> and VO<sub>2</sub> max</h4>
            <p>
                VO<sub>2</sub> is oxygen uptake in milliliters of oxygen per kilogram and so is a weight independent measure of how much oxygen an athlete is consuming at some point in time.
                VO<sub>2</sub> max is the maximum oxygen uptake possible in a particular athlete during a maximally intense activity.
            <p>            
                The graph below demonstrates the relationship between exercise intensity, VO<sub>2</sub>, VO<sub>2</sub> max and blood lactate.  
                The yellow arrow shows the increase in intensity of an activity and so energy consumption.  
                The red graph shows that initially oxygen consumption (VO<sub>2</sub>) keeps pace and we metabolize glucose aerobically and don't produce an excess of lactic acid.  
                As the intensity increases further we reach the limit at which our body is able to utilize oxygen (VO<sub>2</sub> max).  
            ...
            <img class = "centerImage90" src = "../Images/LactateThreshold.png" alt ="pic">



            <h4>VO<sub>2</sub> max and Lactate Threshold</h4>

            <p>
                There is clearly a relationship between VO<sub>2</sub> max and Lactate Threshold.  
                Above VO<sub>2</sub> max any sustained additional energy production must come from glycolysis 
                The reason the VO<sub>2</sub> at lactate threshold is not equal to VO<sub>2</sub> max is because the switch over to anaerobic metabolism happens progressively
                below VO<sub>2</sub> max. The rate of switchover is something that is very amenable to training as we will see below.
                We might choose to call the VO<sub>2</sub> at which lactate levels start to rise appreciably the VO<sub>2</sub> LT (Lactate Threshold).  
                It is somewhat lower then VO<sub>2</sub> max.
            </p>


            <p>           
                VO<sub>2</sub> max is heavily genetically determined both in its untrained level and its response to training.  
                The typical person can expect a modest maximal increase of up to 15%.  
                But there are much bigger gains to be made.  
                To understand this requires knowledge of the interrelationship between lactate threshold and VO<sub>2</sub> max as we get fitter.  
            </p>

            <img style="float:right; width: 40%; margin: 10px 0px 20px 50px;" src="../Images/Lactate.png">

            <p>    

                Training makes lactate elimination more efficient.  
                This means that blood lactate is lower for a given intensity of exercise below VO<sub>2</sub> max.  
                Of course this reduction in lactate for a particular exercise intensity must ultimately fail as we approach and then exceed VO<sub>2</sub> max and so perhaps 
                frustratingly eventually bump up against our own genetic limitations.
            </p>
            <p>
                The biggest improvements in performance for most endurance athletes stem from being able to get close to and sustain activity just below VO<sub>2</sub> max,
                and to do so without rapidly metabolizing glucose (and therefore their glycogen reserves).
                This improvement is as a result of the change in shape of the lactate curve which increasingly develops the so called "hockey stick" with lactate levels only rising when close to VO<sub>2</sub> max.
                The recovery of lactate is an oxygen consuming process and so in part the modest increase in VO<sub>2</sub> max with training results from the 
                improvement in lactate metabolism.
                Representative lactate plots vs. %VO<sub>2(max)</sub> of an untrained and a trained athlete are shown above right for comparison.
            </p>

            <iframe style="float:right; margin: 10px 0px 20px 50px;" src="https://www.youtube.com/embed/kZLaxdSr3c0" height="336" title="YouTube video player" frameborder="0"  allowfullscreen></iframe>

            <p>
                To demonstrate this I have produced this animation with VO<sub>2</sub> on the x axis and blood lactate on the y.  
                The left hand vertical red line indicates VO<sub>2</sub> at LT and the right hand one VO<sub>2</sub> max.
                ...
                VO<sub>2</sub> max increases a little with training and this moves the whole lactate curve to the right.  
                VO<sub>2</sub> LT moves more dramatically to the right influenced by this shift and the increasing bend in the curve as lactate elimination improves.  
                The VO<sub>2</sub> LT datum is far more relevant to endurance athletes and typically an activity of this intensity can be sustained for around half an hour
            ...
            <h4>What about MLSS, OBLA, AT, VT etc...</h4>    

            <aside>
                MLSS - Maximum Lactate Steady State<br>
                OBLA - Onset of Blood Lactate Accumulation<br>
                AT - Anaerobic Threshold<br>
                VT - Ventilatory Threshold 
            </aside>

            <p>
                Of course a plot of lactate vs. intensity of activity (power, flat pace etc...) does not have a "point" where lactate suddenly starts rising.
            ...
            <p>
                But we can then choose to bring in a time element and define the lowest intensity where blood lactate does <b><i>not</i></b> reach a steady level but continues to rise.
            ...
            <p>
                But what about all the other thresholds?
                ...
                It does so because, in addition to the CO<sub>2</sub> from aerobic metabolism, CO<sub>2</sub> is also produced from the buffering of lactate from anaerobic metabolism by bicarbonate.
                It is therefore merely a surrogate for the lactate threshold.          
            </p>


            <p>
                So we see that there are really only two types of definition of lactate threshold.
            ...
            <h4>Training Variety and Lactate Threshold</h4>

            <p>
                Of course training and improving the efficiency of lactate elimination is not the only element of training.  
            ...
            <p>
                We also need to know where our lactate threshold is in order to avoid it!
            ...
            <table>
                <tr >
                    <td style = "width: 50%;"><img src="../Images/EasyRun.png" style="margin-left:auto; margin-right: auto; display:block; width: 93%; height: 93%"></td>
                    <td style = "width: 50%;"><img src="../Images/HardRun.jpg" style="margin-left:auto; margin-right: auto; display:block; width: 81%; height: 81%; text-align: center;"></td>
                </tr>
                <tr>
                    <td style="text-align: center; font-size: 70%; font-weight: bold;">Easy Long Run (with Dogs!)</td>
                    <td style="text-align: center; font-size: 70%; font-weight: bold;">Hard Run (Cardiff <sup>1</sup>/<sub>2</sub> Marathon Race)</td>
                </tr>
            </table>

            <h4>Lactate Threshold vs. FTP, rFTPw, LTHR etc...</h4>

            <p>           
                But what about all the different threshold values out there?  
                ...
                <span style="font-weight: bold; font-style: italic;">We just have to calibrate each sport and metric combination relative to this.</span>
                (In fact, for convenience, for a particular sport, we can obtain LT HR, LT Pace, LT Power all in one go during a field test)
            </p>

            <h4>Methods for Determining Lactate Threshold</h4>

            <img  src ='../Images/LactateThresholdMeasurement.png' style="width: 100%;">

            <p>           
                ​​OK.  How do we find out our lactate threshold?  
            </p>

            <h5>Measure Directly</h5>

            <p>
                Of course the gold standard would be to measure blood lactate and our metric of interest (HR, pace, power) while doing a particular activity (run, bike, swim)
                as we progressively increase activity and find the point where blood lactate starts to sharply increase.  
                This is typically done in a laboratory along with measurement of VO<sub>2</sub> max.  
            ...
            <h5>Estimate with a Field Test</h5>

            <p>
                Fortunately there are field tests that can give estimated values that are very well correlated with laboratory measured values.  
                We can also do them every few weeks as our training progresses to recalibrate our training zones.
            </p>

            <p>            
                After a suitable warm up you merely need to start a workout and maintain a constant maximum effort over 30 minutes in your chosen sport.  
            ...
            <p>            
                So if we were to do this successfully for running with a gps watch, a heart rate strap and a Stryd foot pod we could at once find out our running threshold pace, heart rate and power.  
            ...
            <h5>Lactate Threshold Heart Rate - LTHR</h5>

            <p>            
                Because heart rate lags behind changes in activity intensity it is customary in a 30 minute field test to discard the first 10 minutes of readings.
                You do a 30 minute test but it is the average of the last 20 minutes that is used to estimate LTHR.
            </p>

            <h5>The Non-Linearity of Heart Rate in relation to Exercise Intensity and Duration of Activity</h5>

            <p>
                Heart rate above resting heart rate exhibits an approximately linear relationship to exercise intensity (running pace, cycling power)
            ...
            <p>        
                It is easy to see some of the limitations of using heart rate.  
            ...
            <h5>Estimate from Accrued Ordinary Workout Data</h5>

            <p>
                Many sports watches and some foot pods use third proprietary algorithms to predict lactate threshold and other quasi threshold metrics from routine data.
            ...
            <h3>Zones, Zones and More Zones</h3>

            <p>           
                There are a large number of zone (zonal) systems out there resulting from combinations of activity type, metric and authority (coach, sporting organisation, equipment provider).  
            ...
            <p>
                If we compare the following two examples, lactate threshold zones from different authorities:
            </p>
            ...
            $table->addCaption('Stryd');
            $table->setTableStyle('width', '30ch');
            echo $table->toString();
            ?>

            <p>        
                Although sharing the same common structure, zones as ranges of percentages of a threshold value, they are rather different.  
            ...
            $table->addCaption('Joe Friel - Bike');
            $table->setTableStyle('width', '30ch');
            echo $table->toString();
            ?>


            <h4>Critical Power</h4>

            <a class="buttonRight" href="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5070974/">Critical Power</a>

            <p>
                I feel that I should now discuss critical power.
            ...
            <figure class="centerImage90">
                <img style='width:45%;' src ="../Images/PowerCurve.png">
                <img style='width:45%;' src ="../Images/PowerLine.png">
                <figcaption>
                    A typical power-duration curve and line for an athlete.
            </figure>

            <aside style='width:20%'>
                It is remarkable that this relationship seems universal across species and so must represent something quite fundamental.
            </aside>

            <p>
                There is a threshold intensity of training, the critical power, below which there is no time limitation of activity.
                ...
                It can be shown that a very simple equation describes this relationship, which is commonly referred to as a power curve, and is stated below.
            </p>



            <?php mountFormulaOnCard(makeEquation(['t = ', makeFrac('w<sub>a</sub>', '(p - p<sub>c</sub>)')]), 'w<sub>a</sub> = anaerobic reserve power; p = power; p<sub>c</sub> = critical power')->echo(); ?>
            ...
            <p>
                w<sub>a</sub> 
                is a constant value with units of energy and could be thought of as representing some depletable anaerobic reserve metabolism. 
            ...
            <?php mountFormulaOnCard(makeEquation(['p = ', makeFrac('w<sub>a</sub>', 't'), ' + ', 'p<sub>c</sub>']), 'w<sub>a</sub> = anaerobic reserve power; p = power; p<sub>c</sub> = critical power')->echo(); ?>

            <p>
                We just need to fit a line between these points.
                The gradient is w<sub>a</sub> and the intercept p<sub>c</sub>.
            ...
            <img class="centerImage50" src="../Images/MyPowerCurves.png">

            <p>               
                Luckily modern watch and web site technology allow an individual to accumulate a large data set of power and duration data pairs.
            ...
            <p>
                For a steady power of 60 minutes or more in duration the theoretical power-duration curve is very close to the horizontal plot of CP.
            ...
            <p>
                It would be good to have a simple descriptive system to describe predicted or measured steady state power-duration values rather than a plethora of confusing
                and ambiguous terms.
            </p>


            <?php
            $itemStyle = 'font-weight: bold; margin-left: 5ch;';
            $fontStyle = 'font-size: 75%; font-weight: bold;';
            $ul = new Tag("ul");
            $ul->makeChild('li', 'P<sub>∞</sub> &nbsp &nbsp', ['style' => $itemStyle])->makeChild('font', 'true critical power - CP', ['style' => $fontStyle]);
            $ul->makeChild('li', 'P<sub>60</sub> &nbsp &nbsp', ['style' => $itemStyle])->makeChild('font', 'functional threshold power - FTP (also incorrectly referred to as critical power - CP', ['style' => $fontStyle]);
            $ul->makeChild('li', 'P<sub>30</sub> &nbsp &nbsp', ['style' => $itemStyle])->makeChild('font', 'lactate threshold power - LTP', ['style' => $fontStyle]);
            $ul->echo();
            ?>


            <h5>The Limitations of the Critical Power Concept</h5>

            <p>
                It is easy to see that this idea fails for very short efforts.
            ...
            <h4>Critical Flat Speed</h4>

            <p>
                There is linear relationship between power and speed when running on the flat S = k × P.
                From this it can be seen that there must be a critical speed, just as there is a critical power S<sub>c</sub>.
                There must also be an anaerobic reserve distance D<sub>a</sub> or ARD!
                So for a race of distance D<sub>r</sub> we can state:
            </p>


            <?php mountFormulaOnCard(makeEquation(['D<sub>r</sub>', '=', 'S<sub>c</sub>', '×', 't<sub>r</sub>', '+', 'D<sub>a</sub>']))->echo(); ?>


            <p>
                This is simpler than a power curve, a straight line.
                ...
                If we plot recent race distances vs. duration, a fitted line will have a slope of S<sub>c</sub> and intercept of D<sub>a</sub>.
                From this line it is easy to Tools::interpolate your lactate threshold speed (30 mins duration) and also predict your race duration for a flat race at another distance.
            </p>
            ...
            mountFormulaOnCard(
                    makeEquation(
                            [
                                ...
                                makeFrac(
                                        makeEquation(['D<sub>2</sub>', '-', 'D<sub>a</sub>']),
                                        makeEquation(['D<sub>1</sub>', '-', 'D<sub>a</sub>'])
                                )
                            ]
                    ))->echo();
            ?>
            ...
            <p>
                This differs from Peter Riegel's formula:
            </p>


            <?php
            mountFormulaOnCard(makeEquation(
                            [
                                't<sub>2</sub>', '=', 't<sub>1</sub>', '×',
                                makeBrace('['),
            ...
            <p>
                The formula based on critical flat speed and anaerobic reserve distance under-estimates race times for longer distances such as the marathon.
            ...
            <p>
                My most recent race distances are a half-marathon in 113 minutes and a 10k in 53 minutes.
                It is easy to see that my S<sub>c</sub> = 11 km/h and my D<sub>a</sub> is just 0.283 km.
            ...
            <h3>Don't Mix Things Up</h3>
            <p>            
                Of course each authority is keen to promote their zonal system as best.  
            ...
            <p>
                In reality you might undertrain or worse overtrain and injure yourself.
            </p>

            <img class="centerImage50" src="../Images/tema.png">

            <h3>Now Mix Things Up</h3>

            <p>
                We have covered the physiological basis of training zones and how, for endurance athletes, the best choice of basis for these is lactate threshold 
            ...
            <!--a class='buttonRight' href="Metrics.php">Training Intensity Measures</a-->
